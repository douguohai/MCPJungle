...
| Mcpjungle gateway | Permission-group-scoped client access | Stable | Supported through Dashboard-managed users, device tokens, and permission groups.       |
...
| Database | MySQL 8.0 | Stable | Required for local, test, and shared deployments. Use UTC and `utf8mb4`. |
