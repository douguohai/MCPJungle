...
It uses MySQL 8.0 as its database for both local and production deployments.

If you use the docker-compose.yaml provided in the repository, it will automatically start a MySQL container and ensure connectivity.

## Mcpjungle client
The `mcpjungle` CLI tool you run from your terminal for server management and automation.

Today, the CLI remains the most complete management client, and MCPJungle also includes a Dashboard UI for local/dev visibility and common management tasks.
