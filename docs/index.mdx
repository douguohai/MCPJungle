...
<p align="center">
  <img src="/images/mcpjungle-diagram-april-2026.png" alt="mcpjungle product diagram" />
</p>
...
<CardGroup cols={2}>
  ...
  <Card title="Access Control" icon="shield-halved" href="/governance/access-control">
    In enterprise mode, create personal device tokens and assign permission groups so each client only reaches the servers it should use.
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Start the server">
    Pull the Docker Compose file and start Mcpjungle with a persistent MySQL 8.0 database:
...
<CardGroup cols={2}>
  ...
  <Card title="Access and governance" icon="lock" href="/governance/overview">
    Understand enterprise mode, dashboard-based users, personal device tokens, and permission groups.
  </Card>
