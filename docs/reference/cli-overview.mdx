...
description: "Information about how to use the mcpjungle CLI"
---
...
The file is YAML and contains the following field:
...
This file is non-secret. Human authentication uses the Dashboard session cookie and device tokens are issued and managed in the Dashboard, not in `~/.mcpjungle.conf`.
