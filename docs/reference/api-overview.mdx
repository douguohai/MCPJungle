...
description: "Overview of mcpjungle server REST API and how to interact with it."
---
...
MCP clients (non-human agents) authenticate with their own personal device tokens and are further restricted by the permission groups assigned to the owning user.
