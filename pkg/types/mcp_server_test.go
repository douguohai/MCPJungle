...
func TestMcpServerJSONMarshaling(t *testing.T) {
	...
	expected := `{"name":"json-server","transport":"stdio","status":"online","description":"Server for JSON testing","url":"","command":"/usr/bin/json-server","args":["--verbose"],"env":{"ENV":"test"},"session_mode":"stateless"}`
